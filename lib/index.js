...
var Core = function (_Component) {
  ...
  function Core() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Core).apply(this, arguments));
  }
...
Core.propTypes = {
  ...
  type: _react.PropTypes.oneOf(['doughnut', 'pie', 'line', 'bar', 'radar', 'polarArea', 'bubble']).isRequired
};
